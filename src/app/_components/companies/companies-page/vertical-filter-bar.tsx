    ...
    <div className="hidden p-2 lg:block">
      <Card className="max-w-[200px] rounded xl:max-w-[250px]">
        ...
        <div className="flex flex-col py-2">
          ...
          <div>
            <input type="checkbox" id="network" className="accent-indigo-500" />
        ...
        <div className="flex flex-col py-2">
          ...
          <div>
            <input type="checkbox" id="plus-5b" className="accent-indigo-500" />
            <label htmlFor="plus-5b" className="ml-2">
              +5b
            </label>
          </div>
          <div>
            <input type="checkbox" id="1-5b" className="accent-indigo-500" />
            <label htmlFor="1-5b" className="ml-2">
              1-5b
            </label>
          </div>
          <div>
            <input type="checkbox" id="500m-1b" className="accent-indigo-500" />
          ...
          <div>
            <input type="checkbox" id="50-100m" className="accent-indigo-500" />
        ...
        <div className="flex flex-col py-2">
          ...
          <div>
            <input type="checkbox" id="fintech" className="accent-indigo-500" />
          ...
          <div>
            <input type="checkbox" id="crypto" className="accent-indigo-500" />
        ...
        <div className="flex flex-col py-2">
          ...
          <div>
            <input type="checkbox" id="austin" className="accent-indigo-500" />
            <label htmlFor="austin" className="ml-2">
              Austin
            </label>
          </div>
          <div>
            <input type="checkbox" id="boston" className="accent-indigo-500" />
            <label htmlFor="boston" className="ml-2">
              Boston
            </label>
          </div>
          <div>
            <input type="checkbox" id="miami" className="accent-indigo-500" />
          ...
          <div>
            <input type="checkbox" id="europe" className="accent-indigo-500" />
          ...
          {showMoreRegions ? (
            <div>
              ...
              <div>
                <input type="checkbox" id="sea" className="accent-indigo-500" />
              ...
              <div>
                <input type="checkbox" id="uk" className="accent-indigo-500" />
